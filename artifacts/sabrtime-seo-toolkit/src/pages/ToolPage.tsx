...
export default function ToolPage() {
  ...
  useEffect(() => {
    ...
    if (tool) {
      ...
      const pageUrl = `https://sabrtime.in/seo-tools/tool/${tool.slug}`;
      ...
      if (ogTitle) ogTitle.setAttribute('content', `${tool.name} — Free Online SEO Tool | SabrTime`);
      const ogDescription = document.querySelector('meta[property="og:description"]');
      if (ogDescription) ogDescription.setAttribute('content', tool.description);
