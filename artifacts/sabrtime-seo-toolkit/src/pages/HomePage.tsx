...
export default function HomePage() {
  ...
  useEffect(() => {
    const title = 'Free SEO Tools Online — SabrTime SEO Toolkit';
    const description = '20 free SEO tools for meta tags, schema markup, keyword analysis, technical SEO, and content optimization. No signup required.';
    ...
    const tags: Array<[string, string, string]> = [
      ...
      ['property', 'og:url', 'https://sabrtime.in/seo-tools/'],
    ];
    ...
    canonical.setAttribute('href', 'https://sabrtime.in/seo-tools/');
  }, []);
